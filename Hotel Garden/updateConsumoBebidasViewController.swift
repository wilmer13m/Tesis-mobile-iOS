//
//  updateConsumoBebidasViewController.swift
//  Hotel Garden
//
...
class updateConsumoBebidasViewController: UITableViewController {
    ...
    func siguiente(){
        ...
        let consumoPostreVc = UpdateConsumoPostresViewController(style: .grouped)
        consumoPostreVc.currentOrder = currentOrder
        consumoPostreVc.foodOrder = foodOrder
