//
//  CreateConsumoViewController.swift
//  Hotel Garden
//
...
class CreateConsumoViewController: UITableViewController {
    ...
    func siguiente(){
        ...
        let createConsumoBebidaVc = CreateConsumoBebidasViewController(style: .grouped)
        createConsumoBebidaVc.currentOrder = currentOrder
        
        navigationController?.pushViewController(createConsumoBebidaVc, animated: true)
